...
('전공(필수)', '영어영문학과', '1', 'EN101', '기초영어', '홍교수', '토', '09:00', '09:50', 2, 40),
('전공(선택)', '영어영문학과', '2', 'EN102', '영문학개론', '박교수', '일', '10:00', '10:50', 3, 30),
('전공(필수)', '영어영문학과', '3', 'EN103', '심화영어', '이교수', '월', '11:00', '11:50', 3, 35),
('전공(선택)', '영어영문학과', '4', 'EN104', '영어회화', '김교수', '화', '13:00', '13:50', 2, 25),
('전공(필수)', '영어영문학과', '2', 'EN105', '영어작문', '최교수', '수', '14:00', '14:50', 3, 30),

('전공(필수)', '디자인학과', '1', 'DS101', '기초디자인', '정교수', '목', '09:00', '09:50', 2, 30),
('전공(선택)', '디자인학과', '2', 'DS102', '색채학', '홍교수', '금', '10:00', '10:50', 3, 25),
('전공(필수)', '디자인학과', '3', 'DS103', '타이포그래피', '박교수', '토', '11:00', '11:50', 3, 30),
('전공(선택)', '디자인학과', '4', 'DS104', '웹디자인', '이교수', '일', '13:00', '13:50', 3, 20),
('전공(필수)', '디자인학과', '2', 'DS105', '3D모델링', '김교수', '월', '14:00', '14:50', 3, 15),

('교양(필수)', '교양학부', '1', 'GE101', '논리적사고', '최교수', '화', '09:00', '09:50', 2, 50),
('교양(선택)', '교양학부', '2', 'GE102', '대학수학', '정교수', '수', '10:00', '10:50', 3, 40),
('교양(필수)', '교양학부', '3', 'GE103', '철학입문', '홍교수', '목', '11:00', '11:50', 2, 45),
('교양(선택)', '교양학부', '4', 'GE104', '심리학개론', '박교수', '금', '13:00', '13:50', 3, 35),
('교양(필수)', '교양학부', '2', 'GE105', '경제학원론', '이교수', '토', '14:00', '14:50', 3, 40),

('전공(필수)', '컴퓨터공학과', '1', 'CS106', '데이터베이스', '김교수', '일', '15:00', '15:50', 3, 30),
('전공(선택)', '컴퓨터공학과', '2', 'CS107', '소프트웨어공학', '이교수', '월', '16:00', '16:50', 3, 30),
('전공(필수)', '컴퓨터공학과', '3', 'CS108', '인공지능', '박교수', '화', '17:00', '17:50', 3, 25),
('교양(필수)', '교양학부', '1', 'GE106', '환경과학', '최교수', '수', '15:00', '15:50', 2, 40),
('교양(선택)', '교양학부', '2', 'GE107', '문화와 예술', '정교수', '목', '16:00', '16:50', 2, 30),

('전공(선택)', '영어영문학과', '3', 'EN106', '영문법', '홍교수', '금', '17:00', '17:50', 3, 30),
('전공(필수)', '디자인학과', '4', 'DS106', '사진학', '박교수', '토', '15:00', '15:50', 3, 20),
('교양(선택)', '교양학부', '3', 'GE108', '사회학개론', '이교수', '일', '16:00', '16:50', 3, 40),
('교양(필수)', '교양학부', '4', 'GE109', '문학개론', '김교수', '월', '17:00', '17:50', 2, 35);
